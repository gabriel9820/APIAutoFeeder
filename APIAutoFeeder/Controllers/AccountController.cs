...
using APIAutoFeeder.Providers;
using APIAutoFeeder.Results;
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            if (hasRegistered)
            {
                ...
                AuthenticationProperties properties = ApplicationOAuthProvider.CreateProperties(user.Id, user.FullName, user.PhoneNumber, user.UserName);
        ...
        public async Task<IHttpActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                string emailSubject = "AutoFeeder - Redefinição de senha";
                string emailBody = "Redefina sua senha clicando aqui: <a href=\"" + callbackUrl + "\">link</a><br/>";
